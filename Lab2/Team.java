package Lab2;//necessaria per a què el programa pugui obtenir classes d'altres fitxers dins de la mateixa carpeta
...
public class Team {
    ...
    public void playMatch(int goles_afavor, int goles_against){//funció que s'haurà de treure
